...
public class InputAxisGenerator : MonoBehaviour
{
    ...
    public void GeneratePS4Axes()
    {
        ...
        string[] linesWithNewAxes = GenerateDefaultPS4Axes(lines);
    ...
    string[] GenerateDefaultPS4Axes(string[] lines)
    {
        for (int i = 0; i < 4; ++i)
        {
            string[] newLines = new string[16];
            newLines[0] = "  - serializedVersion: 3";
            newLines[1] = "    m_Name: " + "LeftAnalogX" + (i + 1);
            newLines[2] = "    descriptiveName: ";//deprecated
            newLines[3] = "    descriptiveNegativeName: ";//deprecated
            newLines[4] = "    negativeButton: " + axis.negativeButtonName;
            newLines[5] = "    positiveButton: " + axis.positiveButtonName;
        ...
        for (int i = 0; i < 4; ++i)
        {
            string[] newLines = new string[16];
            newLines[0] = "  - serializedVersion: 3";
            newLines[1] = "    m_Name: " + "LeftAnalogY" + (i + 1);
            newLines[2] = "    descriptiveName: ";//deprecated
            newLines[3] = "    descriptiveNegativeName: ";//deprecated
            newLines[4] = "    negativeButton: " + axis.negativeButtonName;
            newLines[5] = "    positiveButton: " + axis.positiveButtonName;
        ...
        for (int i = 0; i < 4; ++i)
        {
            string[] newLines = new string[16];
            newLines[0] = "  - serializedVersion: 3";
            newLines[1] = "    m_Name: " + "RightAnalogX" + (i + 1);
            newLines[2] = "    descriptiveName: ";//deprecated
            newLines[3] = "    descriptiveNegativeName: ";//deprecated
            newLines[4] = "    negativeButton: " + axis.negativeButtonName;
            newLines[5] = "    positiveButton: " + axis.positiveButtonName;
        ...
        for (int i = 0; i < 4; ++i)
        {
            string[] newLines = new string[16];
            newLines[0] = "  - serializedVersion: 3";
            newLines[1] = "    m_Name: " + "RightAnalogY" + (i + 1);
            newLines[2] = "    descriptiveName: ";//deprecated
            newLines[3] = "    descriptiveNegativeName: ";//deprecated
            newLines[4] = "    negativeButton: " + axis.negativeButtonName;
            newLines[5] = "    positiveButton: " + axis.positiveButtonName;
        ...
        for (int i = 0; i < 4; ++i)
        {
            string[] newLines = new string[16];
            newLines[0] = "  - serializedVersion: 3";
            newLines[1] = "    m_Name: " + "ArrowKeysX" + (i + 1);
            newLines[2] = "    descriptiveName: ";//deprecated
            newLines[3] = "    descriptiveNegativeName: ";//deprecated
            newLines[4] = "    negativeButton: " + axis.negativeButtonName;
            newLines[5] = "    positiveButton: " + axis.positiveButtonName;
        ...
        for (int i = 0; i < 4; ++i)
        {
            string[] newLines = new string[16];
            newLines[0] = "  - serializedVersion: 3";
            newLines[1] = "    m_Name: " + "ArrowKeysY" + (i + 1);
            newLines[2] = "    descriptiveName: ";//deprecated
            newLines[3] = "    descriptiveNegativeName: ";//deprecated
            newLines[4] = "    negativeButton: " + axis.negativeButtonName;
            newLines[5] = "    positiveButton: " + axis.positiveButtonName;
